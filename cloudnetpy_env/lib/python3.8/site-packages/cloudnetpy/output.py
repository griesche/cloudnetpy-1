...
def add_comment() -> str:
    """ Returns comment"""
    comment = (
            "Different known issues have been found in this data set.\n"
            "Tracking of externally caused data issues is documented in an external issue tracking file.\n"
            "Please consider the issue data referenced in the dependencies.\n"
            "Issue flagged data has to be handled with care."
            )
    return comment
